...
<div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
        ...
        <div class="flex-auto p-4">
            ...
            <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Montant inscription</p>
    ...
    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
        ...
        <div class="flex-auto p-4">
            ...
            <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Utilisateurs</p>
    ...
    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
        ...
        <div class="flex-auto p-4">
            ...
            <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Nos étudiants</p>
    ...
    <div class="w-full max-w-full px-3 sm:w-1/2 sm:flex-none xl:w-1/4">
        ...
        <div class="flex-auto p-4">
            ...
            <div class="flex-none w-2/3 max-w-full px-3">
                <div>
                <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Mentions</p>
                <h5 class="mb-2 font-bold dark:text-white">39</h5>
                <p class="mb-0 dark:text-white dark:opacity-60">
                    <span class="text-sm font-bold leading-normal text-emerald-500">+5%</span>
                    Formations orgnaisées
                </p>
                </div>
            </div>
            <div class="px-3 text-right basis-1/3">
    ...
    <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
        ...
        <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
            <h6 class="capitalize dark:text-white">Statistique d'inscription</h6>
            <p class="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
            <i class="fa fa-arrow-up text-emerald-500"></i>
            <span class="font-semibold">Années academiques :</span> de 2019 à 2022
            </p>
        </div>
        <div class="flex-auto p-4">
            <div>
    ...
    <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
        ...
        <div slide class="absolute w-full h-full transition-all duration-500">
            ...
            <h5 class="mb-1 text-white">Recente Actualité</h5>
            <p class="dark:opacity-80">Collation des grades 2022</p>
            </div>
        </div>
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none">
            ...
            <div class="p-4 pb-0 mb-0 rounded-t-4">
                ...
                <h6 class="mb-2 dark:text-white">Inscription par section</h6>
                </div>
            </div>
                        ...
                        <tr>
                            <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                <div class="flex items-center px-2 py-1">
                                    <div class="ml-6">
                                        <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Section:</p>
                                        <h6 class="mb-0 text-sm leading-normal dark:text-white">Sciences exactes</h6>
                                    </div>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                <div class="text-center">
                                    <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Nbr Dep:</p>
                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">4</h6>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                <div class="text-center">
                                    <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Montant total:</p>
                            ...
                            <td class="p-2 text-sm leading-normal align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                <div class="flex-1 text-center">
                                    <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Nombre d'inscrit:</p>
                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">140 étudiants</h6>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                <div class="flex items-center px-2 py-1">
                                    <div class="ml-6">
                                        <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Section:</p>
                                        <h6 class="mb-0 text-sm leading-normal dark:text-white">Technique</h6>
                                    </div>
                                </div>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
        ...
        <div class="w-full max-w-full px-3 mt-0 lg:w-5/12 lg:flex-none">
            <div class="border-black/12.5 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                <div class="p-4 pb-0 rounded-t-4">
                    <h6 class="mb-0 dark:text-white">Departements</h6>
                </div>
                <div class="flex-auto p-4">
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                            ...
                            <div class="flex flex-col">
                                <h6 class="mb-1 text-sm leading-normal text-slate-700 dark:text-white">Informatique</h6>
                                <span class="text-xs leading-tight dark:text-white/80">Sciences exactes | <span class="font-semibold">3 Mentions</span></span>
                            </div>
                            </div>
                            <div class="flex">
                        ...
                        <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                            ...
                            <div class="flex flex-col">
                                <h6 class="mb-1 text-sm leading-normal text-slate-700 dark:text-white">Chimie</h6>
                                <span class="text-xs leading-tight dark:text-white/80">Sciences exactes | <span class="font-semibold">2 Mentions</span></span>
                            </div>
                            </div>
                            <div class="flex">
                                <button class="group ease-in leading-pro text-xs rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i class="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
                        ...
                        <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                            ...
                            <div class="flex flex-col">
                                <h6 class="mb-1 text-sm leading-normal text-slate-700 dark:text-white">Agrovet</h6>
                                <span class="text-xs leading-tight dark:text-white/80">Technique | <span class="font-semibold">4 Mentions</span></span>
                            </div>
                            </div>
                            <div class="flex">
                                <button class="group ease-in leading-pro text-xs rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i class="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
